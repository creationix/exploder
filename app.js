...
var sparks = []
var sources = {}
var start = 0; var before

// Create a few balls on the screen
var x = 0
var rad = 0
var r = Math.min(window.innerHeight, window.innerWidth) / 2
while (r >= 24) {
  var c = Math.PI * r * 2
  var count = c / 48
  ...
  var ball = new Sprite(sheet.textures[colorName])
...
function explode(x, y, owner) {
  ...
  for (var i = start; i < end; i += 72) {
    var spark = new Sprite(sheet.textures.dart)
